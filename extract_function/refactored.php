...
function stampaScadenze($scadenze){
	stampaIntestazione($scadenze);
	stampaFatture($scadenze);
	stampaTotale($scadenze);
}

function stampaIntestazione($scadenze){
...
function stampaFatture($scadenze){
...
function stampaTotale($scadenze){
	$totale=0;
	foreach($scadenze['fatture'] as $fattura){
